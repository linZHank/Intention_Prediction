"""Test lenet with mnist tfrecord input"""
...
import data_utils_test # make sure it is in the same dir
import os
import glob
import time


tfrecords_dir = "/home/linzhank/playground/mnist_tfrecord/"
train_filenames = glob.glob(os.path.join(tfrecords_dir, "train", "train*"))
eval_filenames = glob.glob(os.path.join(tfrecords_dir, "test", "test*"))
