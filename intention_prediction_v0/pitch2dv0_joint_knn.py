...
predevenfilename = os.path.join(result_path, "joint_knn_pred_even.txt")
...
preddiscfilename = os.path.join(result_path, "joint_knn_pred_disc.txt")
np.savetxt(preddiscfilename, pred_disc, fmt="%d")
# Save logarithm weighted predictions
predlogrfilename = os.path.join(result_path, "joint_knn_pred_logr.txt")
