"""Test alexnet on pitch2dv0 color image data with double GPUs"""
...
for i,nf in enumerate(num_frames):
  ...
  classifier = tf.estimator.Estimator(
    model_fn=tf.contrib.estimator.replicate_model_fn(alexnet_model_fn),
    model_dir="/tmp/pitch2dv0_color_alex2g_frame{}".format(nf)
  )
